-- Derived view: PR review lag.
-- Which PRs are stuck, how long they've waited, and who the bottleneck reviewer is.
-- Source: Fivetran-synced GitHub tables (pull_request, review, requested_reviewer).
--
